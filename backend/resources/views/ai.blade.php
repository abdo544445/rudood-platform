        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0 align-items-lg-center">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-dark dropdown-menu-end shadow border border-secondary border-opacity-25 rounded-3 mt-2">
              ...
              <li><a class="dropdown-item py-2" href="{{ url('/chat') }}"><i class="bi bi-chat-dots me-2 text-gold"></i>إدارة المحادثات</a></li>
              <li><a class="dropdown-item py-2 active text-gold fw-bold" href="{{ url('/ai') }}"><i class="bi bi-cpu me-2 text-gold"></i>الذكاء الاصطناعي 24/7</a></li>
            </ul>
          </li>
          <li class="nav-item"><a class="nav-link px-3" href="{{ url('/blog') }}">المدونة</a></li>
        </ul>

        <div class="d-flex align-items-center gap-3">
          <a href="{{ url('/login') }}" class="nav-link text-white-50 hover-gold">تسجيل الدخول</a>
          <a href="{{ url('/login') }}" class="btn btn-gold text-dark fw-bold rounded-pill px-4 py-2">ابدأ مجاناً</a>
        </div>
      </div>
    </div>
  </nav>
