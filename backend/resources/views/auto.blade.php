        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0 align-items-lg-center">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-dark dropdown-menu-end shadow border border-secondary border-opacity-25 rounded-3 mt-2">
              <li><a class="dropdown-item py-2 active text-gold fw-bold" href="{{ url('/auto') }}"><i class="bi bi-robot me-2 text-gold"></i>خدمات الرد الآلي</a></li>
              <li><a class="dropdown-item py-2" href="{{ url('/chat') }}"><i class="bi bi-chat-dots me-2 text-gold"></i>إدارة المحادثات (العرض التجريبي)</a></li>
